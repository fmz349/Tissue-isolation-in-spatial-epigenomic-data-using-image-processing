...
object <- readRDS("~/ME11_H3K4me3_50um/seurat_object")
...
saveRDS(ves,file="~/ME11_H3K4me3_50um/new_vesalius/new_vesalius_embedding.Rds")
...
for(i in 1:30){
  p[[i]] <- imagePlot(ves_eh, dims = i, cex = 12)+coord_flip()+scale_x_reverse()+ theme_void()
}
...
saveRDS(ter,"~/ME11_H3K4me3_50um/new_vesalius/ter")
