...
proj_in_tissue <- loadArchRProject("~/ME11_H3K27ac_50um/Save-Proj_in_tissue1")
...
saveArchRProject(ArchRProj = proj_in_tissue,
                 outputDirectory = "~/ME11_H3K27ac_50um/ArchR_Proj_in_tissue_predicted",
                 load = FALSE)
...
spatial.obj <- readRDS("~/ME11_H3K27ac_50um/seurat_object")
spatial.obj <- AddMetaData(object = spatial.obj, metadata = meta.data.integration)

saveRDS(spatial.obj, file = "~/ME11_H3K27ac_50um/seurat_object_predicted")
...
saveRDS(object2,"~/ME11_H3K27ac_50um/new_vesalius/seurat.predictgroup.ter")

group.ter <- object2@meta.data[c("predictedGroup","Territory_Trial_1")]

# plot different predict groups
...
ids.highlight <- "Oligodendrocyte Progenitors"
